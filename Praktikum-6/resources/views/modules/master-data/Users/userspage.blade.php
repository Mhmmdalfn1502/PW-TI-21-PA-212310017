...
@section('content')
    <div class="row mt-5">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <a href="{{ route('m_users_detail', $product->id) }}" title="Detail"
        ...
        <div class="col-lg-4 col-xxl-4">
            @include('modules.master-data.users.create')
        </div>
    </div>
    ...
    <script>
        const RemoveItem = (id) => {
            if (confirm("Are you sure wants to remove this item ?")) {
                ...
                xmlhttp.onload = function() {
                    ...
                    alert(data.message);
                    window.location.href = "{{ route('m_users') }}";
                }
                xmlhttp.open("GET", "{{ url('') }}/master-data/users/remove/" + id);
                xmlhttp.send();
            }
        }
        ...
        const EditItem = (id) => {
            ...
            xmlhttp.open("GET", "{{ url('') }}/master-data/users/edit/" + id);
            xmlhttp.send();
        }
    </script>
@endsection
