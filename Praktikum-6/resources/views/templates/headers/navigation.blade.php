                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 justify-content-center align-items-center">
                    ...
                    <li class="nav-item dropdown ms-2">
                        <a class="nav-link" href="#" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <img src="{{ url('./assets/media/icons/IMG_4726.JPG') }}" style="border-radius: 100px" alt="icon-user" width="35px" height="35px" class="bg-light p-1 rounded">
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li class="px-8 py-2 border-bottom mb-2">
                                <div class="d-flex flex-row justify-content-center align-items-center">
                                <img src="{{ url('./assets/media/icons/IMG_4726.JPG') }}" alt="icon-user" width="50px" height="50px" class="bg-light p-1 rounded">
                                <div class="user ms-2">
                                    <p class="mb-0 fw-bolder d-flex align-items-center fs-6">Muhammad Alfan</p>
                                    <span class="text-muted text-hover-primary fs-7">212310017@student.ibik.ac.id</span>
                                </div>
                                </div>
                            </li>
